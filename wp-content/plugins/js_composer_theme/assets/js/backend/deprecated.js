  ...
  var ElementBlockView = vc.element_block_view = Backbone.View.extend({
    ...
    createElement:function (e) {
      ...
      if (this.container.$content.is('#visual_composer_content')) {
         if ($button.data('element') == 'mk_page_section') {
              page_section = Shortcodes.create({shortcode:'mk_page_section'});
              section_column = Shortcodes.create({shortcode:'vc_column', params:{width:'1/1'}, parent_id:page_section.id, root_id:page_section.id });
          } else {
