	...
	public function getControlAddElement() {
		return '<li class="vc_show-mobile">'
		       ...
		       /* MK framework addition */
				...
				.'     <a href="javascript:;" class="vc_icon-btn vc_element-button vc_page_section_icon" data-model-id="vc_element" id="vc_add-page-section-button" title="'
				          .''. __( 'Add New Page Section', 'js_composer' ) . '">'
				.'     </a>'
				.'</li>';
	}
